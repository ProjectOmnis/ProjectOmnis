...
function showTypingIndicator() {
    ...
    typingIndicator.innerHTML = `<strong>Project Omnis:</strong> <em>Typing...</em>`;
...
function sendMessage() {
    ...
    setTimeout(() => {
        ...
        appendMessage('Project Omnis', botMessage);
...
function generateResponse(userMessage) {
    ...
    // Boundary for inappropriate questions
        ...
        return "Project Omnis will not respond to inappropriate language.";
    }
    }
